...
We built a **Datadog-powered observability layer** into our app **Storytopia** using **Datadog’s LLM Observability SDK** to capture rich telemetry on our AI agents. To learn more about the app we built, **watch the Storytopia demo video**  
https://youtu.be/BhiitgdIuEI?si=FYKTivFRG2D_bhGR
